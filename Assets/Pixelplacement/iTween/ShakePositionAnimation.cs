...
public class ShakePositionAnimation : MonoBehaviour {
	...
	void Start () {
		...
		iTween.ShakePosition (gameObject, iTween.Hash ("x", ShakeByX, "y", ShakeByY, "z", ShakeByZ, "delay", delay, "time", time, "includechildren", includechildren, "easeType", easeType, "loopType", loopType));
